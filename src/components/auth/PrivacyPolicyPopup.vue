  ...
  <Popup @close="close()">
    ...
    <template v-slot:body>
      ...
      <p>
        ...
        предпринимаемые Глазковым Никитой Олеговичем (далее – Оператор).
        ...
        http://platform.catcherry.ru. <br /><br />
      </p>
      ...
      <p>
        ...
        http://platform.catcherry.ru; <br />2.4. Информационная система
        ...
        http://platform.catcherry.ru; <br />2.9. Пользователь – любой посетитель
        веб-сайта http://platform.catcherry.ru; <br />2.10. Предоставление
        ...
        персональным данным каким-либо иным способом; <br />2.12. Трансграничная
        ...
        лицу; <br />2.13. Уничтожение персональных данных – любые действия, в
      ...
      <p>
        ...
        Номера телефонов; <br />3.4. Год, месяц, дата и место рождения;
        <br />3.5. Фотографии; <br />3.6. Также на сайте происходит сбор и
        ...
        других). <br />3.7. Вышеперечисленные данные далее по тексту Политики
        объединены общим понятием Персональные данные. <br /><br />
      </p>
      ...
      <p>
        ...
        содержащимся на веб-сайте. <br />4.2. Также Оператор имеет право
        ...
        письмо на адрес электронной почты admin@catcherry.ru с пометкой «Отказ
      ...
      <p>
        ...
        специальные формы, расположенные на сайте http://platform.catcherry.ru.
        ...
        сохранение файлов «cookie» и использование технологии JavaScript).<br /><br />
      </p>
      ...
      <p>
        ...
        электронной почты Оператора admin@catcherry.ru с пометкой «Актуализация
        персональных данных». <br />6.4. Срок обработки персональных данных
        ...
        admin@catcherry.ru с пометкой «Отзыв согласия на обработку персональных
        данных». <br /><br />
      </p>
      ...
      <p>
        ...
        Оператору с помощью электронной почты admin@catcherry.ru.<br />
        ...
        http://platform.catcherry.ru/signup/.
      </p>
    </template>
    <template v-slot:footer>
      <h2>
        <button class="btn btn-primary block" @click="accept()">
          {{ $t("privacyPolicy.acceptBtn") }}
        </button>
      </h2>
    </template>
  </Popup>
